package org.jeecg.modules.ietm.projectmanagement.vo;
 ...
 */
@Data
@ApiModel(value = "ietm_projectPage对象", description = "手册管理-手册项目管理列表")
public class IetmProjectPage {
    ...
    private IetmProjectParams projectParam;

    @ApiModelProperty(value = "项目管理-单位信息")
    private List<String> projectUnits;

...
public class IetmIcnManageController extends JeecgController<IetmIcnManage, IIetmIcnManageService> {
	...
	public Result<IPage<IetmIcnManage>> queryPageList(IetmIcnManage ietmIcnManage,
	 ...
	 * @return
	 */
	@AutoLog(value = "项目管理-项目实体管理-添加")
	@ApiOperation(value="项目管理-项目实体管理-添加", notes="项目管理-项目实体管理-添加")
	//@RequiresPermissions("icnmanage:ietm_icn_manage:add")
	@PostMapping(value = "/add")
	public Result<String> add(@RequestBody IetmIcnManage ietmIcnManage) {
		ietmIcnManageService.save(ietmIcnManage);
	...
	public Result<String> delete(@RequestParam(name="id",required=true) String id) {
		ietmIcnManageService.removeById(id);

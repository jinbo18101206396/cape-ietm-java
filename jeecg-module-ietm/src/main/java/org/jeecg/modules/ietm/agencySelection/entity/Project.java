 ...
 */
@TableName("project")
@ApiModel(value = "project对象", description = "机构遴选-项目表")
public class Project implements Serializable {
    ...
    @Excel(name = "项目数量", width = 12)
    @ApiModelProperty(value = "项目数量")
    private Integer quantity;

    @Excel(name = "状态", width = 10)
    @ApiModelProperty(value = "状态：已分配/待分配")
    private String status;

    @TableField("agency_id")
    @ApiModelProperty(value = "分配机构ID")
    ...
    @Excel(name = "抽取时间", width = 14)
    @TableField("extract_time")
    @ApiModelProperty(value = "抽取时间")
    private String extractTime;

    @Excel(name = "抽取人员", width = 12)
    @TableField("extract_user")
    ...
    public String getExtractTime() { return extractTime; }
    public void setExtractTime(String extractTime) { this.extractTime = extractTime; }
